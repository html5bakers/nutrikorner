...
---------------------------------------------  */
/*global document, window, yall, setTimeout, Swiper, createElementWithClass, createRatingsHtmlElement, Cookies, semanticTabs, Image, Shopify, Event */
/*//jshint esversion: 6 */
...
function create_slider(el, settings, minSlides) {
    ...
    //new_css('css-swiper', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-swiper.css?v=111603181540343972631676725312');
		...
		Default = {
          ...
          window.addEventListener("inputPadding", function (evt) {
            ...
            window.dispatchEvent(inputPaddingEvt);
					...
					var check_limit_event = new CustomEvent('check-limit-event');
								...
								if (el.tagName.toLowerCase() === 'a') {
									el.addEventListener('click', function (e) {
										if (html_tag.classList.contains('t1ac')) {
											...
											new_css('accessible-mode-css', "//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/theme-accessible.css?v=19045189261056603801676725312");
				...
				mobile: function () {
					...
					new_js("//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/scripts-async.js?v=60194485859745510721692961591");
				},
				ratings: function () {
        ...
        backgrounds: function () {
          var align_middle = document.getElementsByClassName('align-middle'),
            ...
            if (content_id) {
				...
				swipers: function () {
          var module_featured, list_panel_slider, list_testimonials, list_static, list_usp, popup_a, list_collection_slider, module_collection, list_product_slider, data_update_product_slider, autoplay_top_int;
          ...
          window.addEventListener("announcementSlider", function(event) {
            top_bar = document.querySelector('#shopify-section-announcement-bar:not(.s4wi)');
  					if (top_bar && top_bar.children.length > 1) {
						  ...
						  mainSlider = create_slider(mainSliderElement, {
							  ...
							  on: {
								  ...
								  afterInit: function (swiper) {
									  ...
									  Array.from(swiper.el.getElementsByClassName('label')).forEach(function (em) {
...
window.addEventListener("showAlert", function(event) {
	...
	if (list_alerts === null) {
		...
		if (document.getElementById('shopify-section-footer')) {
			document.getElementById('shopify-section-footer').parentNode.insertBefore(list_alerts, document.getElementById('shopify-section-footer').nextSibling);
		} else {
			document.getElementById('content').parentNode.insertBefore(list_alerts, document.getElementById('content').nextSibling);
		}
	}
