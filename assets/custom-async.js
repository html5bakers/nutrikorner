...
var html_tag = document.documentElement,
	...
	footer_id = document.getElementById('shopify-section-footer'),
	...
	header_id = document.getElementById('shopify-section-header'),
	...
	top_bar = document.getElementById('shopify-section-announcement-bar'),
...
function nav_burger() {
	...
	if (html_tag.classList.contains('m2a')) {
		...
		new_css('css-menu', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-menu.css?v=89497427242209696611680275368');
	}
}
...
window.addEventListener("nav", function(evt) {
	...
	if (nav_user_id) {
		...
		if (footer_id && nav_id) {
			...
			Array.from(nav_user_id.querySelectorAll('ul[data-type="user-nav"] li:not(.cart) img')).forEach(function (el) {
				"use strict";
...
function asyncCSS() {
	"use strict";
	new_css('async-css', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async.css?v=165608334745216453691688196200');
}
...
function asyncCSS() {
	"use strict";
	new_css('async-css', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async.css?v=165608334745216453691688196200');
	new_css('hovers-css', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-hovers.css?v=97535033354016150111684992579');
}
if (!isMobile) {
...
function validate_me(el) {
	"use strict";
  loadRes("//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-validator.js?v=174245076662832768561680275358", function () {
		...
		new_css('form-validation-css', "//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-validation.css?v=91777376783767526131684404522");
	}, 'validator-loaded');
...
window.addEventListener("showHideDataElement", function (evt) {
	var data_show = document.querySelectorAll('a[data-enable], input[data-enable], button[data-enable]'),
		data_hide = document.querySelectorAll('a[data-disable], input[data-disable], button[data-disable]'),
		data_toggle = document.querySelectorAll('a[data-toggle], input[data-toggle], button[data-toggle]');
...
function dataChange(el) {
	Array.from(document.querySelectorAll(el.getAttribute('data-change'))).forEach(function (em) {
		em.innerHTML = el.getAttribute('title');
	});
}
window.addEventListener("dataChange", function (evt) {
	var data_change = document.querySelectorAll('a[data-change][title], input[data-change][title]');
...
if (form_product_sticky.length) {
	Array.from(form_product_sticky).forEach(function (el) {
		...
		/*if(el.classList.contains('visible')){
			new_css('css-product-scrolled', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-product-scrolled.css?v=15726536326841847381680275367');
...
window.addEventListener("semanticSelect", function (evt) {
	...
	if (select_tag.length && !isMobile) {
		loadRes("//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-selects.js?v=126466181729113866881680275365", function () {
			"use strict";
			Array.from(select_tag).forEach(function (el) {
				...
				//if (el.querySelectorAll('option[selected]:not([disabled]), option[selected]:not(.disabled), option[selected]:not([data-class="disabled"])').length) {
				...
				if (!isMobile) {
					...
					Array.from(el.parentNode.getElementsByClassName('bv_atual')).forEach(function (em) {
						em.addEventListener('click', function () {
							new_css('css-select', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-select.css?v=150870388070401463721680275358');
						});
...
// new_css('css-panels', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-panels.css?v=162615584962978960581681817519');
...
window.addEventListener("imageCompare", function(evt) {
	...
	if (image_compare.length) {
		loadRes('//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-compare.js?v=108280108769912210341676725312', function () {
			"use strict";
			new_css('compare-css', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-compare.css?v=179592741939134901081676725310');
	...
	if (search_id) {
		...
		Array.from(search_input).forEach(function (el) {
			...
			el.addEventListener('focus', function () {
				...
				new_css('css-search', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-search.css?v=74260805215396906641680275366');
			});
		});
...
window.addEventListener("schemeTooltip", function (evt) {
	...
	if (scheme_tooltip.length) {
		// new_css('css-tooltips', "//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-tooltips.css?15233");
...
var loadPopup = function (id) {
	"use strict";
	loadRes('//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-popups.js?v=102441086783179321981680275358', function () {
		var allPopups = document.querySelectorAll('[class^="popup-"]:not(html):not(.ready)');
...
window.addEventListener("popups", function(evt) {
	allApopups = document.querySelectorAll('a[data-popup]:not(.popup-initialized), form[data-popup]'),
	formPopups = document.querySelectorAll('form[data-popup]');
...
window.addEventListener("listScrollable", function(evt) {
	...
	if (list_collection.length) {
		Array.from(list_collection).forEach(function (el) {
			...
			if (el.closest('li.sub') !== null && el.parentNode.parentNode.children.length === 1) {
				el.closest('li.sub').classList.add('no-sub');
			}
...
window.addEventListener("gridListSwitch", function(evt) {
	...
	var list_view = document.getElementsByClassName('l4vw');
	if (list_view.length) {
	...
	// .m6cl, grid/list switcher (collection)
	// var module_collection = document.getElementsByClassName('m6cl');
	// if (module_collection.length) {
	// 	Array.from(module_collection).forEach(function (el) {
	// 		"use strict";
	// 		html_tag.classList.add('t1cl');
	// 		var im = el,
	// 			view_item = el.querySelectorAll('.l4vw li'),
	// 			view_list = el.querySelectorAll('.l4cl');
	// 		el.querySelectorAll('a > i[class*="icon-view-"]').forEach(function (el) {
	// 			el.parentElement.addEventListener('click', function (e) {
	// 				view_item.forEach(function (el) {
	// 					el.classList.remove('active');
...
window.addEventListener("rangeSlider", function(evt) {
	...
	if (input_range.length) {
		loadRes("//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-sliders.js?v=17643888257669127201676725310", function () {
			"use strict";
			new_css('form-sliders-css', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-ui-sliders.css?v=47472693764911078081680275351');
...
/*window.addEventListener("masonry", function(evt) {
	...
	if (list_featured.length) {
		loadRes("//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-masonry.js?v=19905838331864423561676725312", function () {
			"use strict";
			...
			if (el.classList.contains('mobile-sticky')) {
				...
				if (trg !== undefined) {
					...
					function io2(entries) {
						entries.map((entry) => {
							if (el.getBoundingClientRect().top < (header_id.clientHeight + 20))
								if (entry.isIntersecting) {
	...
	if (form_filter.length) {
		...
		Array.from(document.querySelectorAll('a[aria-controls="filter"]')).forEach(function (el) {
			...
			el.addEventListener('click', function (e) {
				...
				new_css('css-filters', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-filters.css?v=139812642784675163181676725313');
				e.preventDefault();
			});
		});
	}
...
window.addEventListener("countdown", function(evt) {
	...
	if (countdown_tag.length) {
		loadRes('//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-countdown.js?v=30852516867416231701676725313', function () {
			"use strict";
...
if (list_count.length) {
	loadRes('//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-countup.js?v=23403240054145588091676725311', function () {
		"use strict";
...
if (link_print.length) {
	Array.from(link_print).forEach(function (el) {
		"use strict";
		el.addEventListener('click', function (e) {
			new_css('css-print', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-print.css?v=7460181328498530131676725310');
			setTimeout(function () {
				window.print();
			}, 400);
			e.preventDefault();
	...
	if (data_fancybox.length) {
		Array.from(data_fancybox).forEach(function (el, index) {
			...
			el.addEventListener('click', function (e) {
				...
				loadRes("//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/plugin-fancybox.js?v=53225757861153421831676725312", function () {
					new_css('css-fancybox', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-fancybox.css?v=57980775351751459211676725311');
...
window.addEventListener("hotspots", function (evt) {
	...
	if (list_hotspots.length) {
		new_css('css-hotspots', '//cdn.shopify.com/s/files/1/0530/4552/6694/t/25/assets/async-hotspots.css?v=173007053730970732721680275350');
...
// Grid or list view
var saveCollectionview = function(view) {
	config = {
		method: 'POST',
		body: JSON.stringify({
				attributes: {
				...
				fetch(button.getAttribute('href'))
					...
					.then((text) => {
						...
						if (curr_products && new_products) {
							if (direction == 'next') {
								curr_products.innerHTML = curr_products.innerHTML + new_products.innerHTML;
							} else {
								curr_products.innerHTML = new_products.innerHTML + curr_products.innerHTML;
							}
						}
					...
					fetch(new_url + "&sections=" + renderSections)
						...
						.then((text) => {
							...
							if (resultsMarkupForm.querySelector('.f8pr-variant-selection') != null) {
								...
								Array.from(productFormSection.querySelectorAll('.f8pr-variant-selection ul.check:has(input[id^="option"])')).forEach(function (el) {
									el.parentNode.replaceChild(resultsMarkupForm.querySelector('#' + el.id), el);
								});
							...
							window.dispatchEvent(popupsEvt);
							window.dispatchEvent(removeSDCcssEvt);
							if (resultsMarkupForm.querySelector('.l4pr').dataset.featured_media_position) {
				...
				fetch(url)
					...
					.then((text) => {
						...
						if (count == calls) {
							...
							if (el.querySelector('.l4cl, .l4ca').children.length == 0) {
								el.innerHTML = '';
								return;
							}
	...
	openQuickshop = function(el) {
		...
		fetch(quickshopUrl)
			...
			.then((text) => {
				...
				if (resultsMarkup.querySelector('#section-info')) { resultsMarkup.querySelector('#section-info').remove(); };
				if (resultsMarkup.querySelector('.product-recommendations')) { resultsMarkup.querySelector('.product-recommendations').remove(); };
				if (resultsMarkup.querySelector('header.mobile-hide')) { resultsMarkup.querySelector('header.mobile-hide').remove(); }
				...
				Array.from(resultsMarkup.querySelectorAll('.pickup, .has-social')).forEach(function (el) {
					el.remove();
				});
